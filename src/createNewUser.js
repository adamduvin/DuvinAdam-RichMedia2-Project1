// Parses the returned JSON and appends messages to the screen
...
// Called when something is returned and appends messages to
// the page based on result and sometimes calls parseJSON
...
// Adds sendPost as an event listener to the add user button
const init = () => {
